...
const logo = "/assets/Job-tracker-logo-D_azGFbg.svg";
const Header = ({ onAddApplication }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-8 md:px-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-bold text-text-dark", children: "Job Track" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Job Track Logo", className: "h-20 w-20" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center space-x-4", children: isLoggedIn ? (
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: currentUser.email }),
          ...
          showUserDropdown && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-0 mt-3 w-43 bg-white rounded-lg shadow-lg border border-gray-200 z-50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2 border-b border-gray-200", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-text-dark", children: currentUser.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-text-medium", children: currentUser.email })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
...
const stock = "/assets/stock-photo-DyQvRGqq.jpg";
const LandingPage = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "container mx-auto flex-grow px-8 md:px-16 py-16 md:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-bold text-text-dark leading-tight", children: [
          "Welcome to the ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Job Track!" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-text-medium", children: "Follow all your job applications easily!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/login",
...
const SocialButton = ({ iconSrc, provider }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "button",
  {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: iconSrc, alt: `${provider} logo`, className: "h-full w-full object-contain" })
  }
);
const hideIcon = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20version='1.1'%20viewBox='0%200%20384%20384'%3e%3c!--%20Generator:%20Adobe%20Illustrator%2029.7.1,%20SVG%20Export%20Plug-In%20.%20SVG%20Version:%202.1.1%20Build%208)%20--%3e%3cdefs%3e%3cstyle%3e%20.st0%20{%20fill:%20%23fff;%20}%20%3c/style%3e%3c/defs%3e%3cpath%20class='st0'%20d='M0,189V0h384v189c-13.74-23.61-31.63-45.67-52.49-63.39-2.01-1.7-11.2-9.74-12.98-9.28-1.06.27-14.66,13.89-15.57,15.26-.51.77-1.13,1.64-.61,2.57.39.69,10.75,7.81,12.65,9.46,16.24,14.05,30.63,30.34,42.62,48.14-43.32,67.66-124.51,111.39-205.72,91.72l-19.91,19.51c11.19,3.23,22.63,5.95,34.23,7.4,90.86,11.41,172.98-38.67,217.77-115.39v189H0v-189c20.24,34.95,49.87,65.77,84.75,86.26.3,1.09-.29,1.25-.73,1.88-7.49,10.88-25.28,22.33-33.41,33.34-7.76,10.5,2.78,23.47,14.65,18.4L333.4,67.52c8.04-10.33-3.46-24.23-15.17-18.17l-41.81,40.61c-5.86-1.96-11.43-4.73-17.27-6.73-32.1-10.95-65.27-13.95-98.89-8.86C92.7,84.6,33.72,130.88,0,189ZM261.75,174c-1.3-.33-1.5.54-2.25,1.12-2.24,1.72-18.58,17.99-19.4,19.6-1.25,2.45-1.16,6.98-1.96,10.04-4,15.29-18.09,29.37-33.38,33.38-3.06.8-7.58.72-10.04,1.96-1.61.82-17.88,17.17-19.6,19.4-.58.75-1.45.95-1.12,2.25,52.53,13.98,101.68-35.26,87.74-87.74Z'/%3e%3cpath%20d='M0,189c33.72-58.12,92.7-104.4,
06,13.71-25.88,26.61-25.88h28.86v-47.25c-16.7-2.96-33.65-4.17-50.62-3.78-22.87,1.71-43.76,12.25-55.19,32.53-14.48,25.7-8.31,56.27-9.61,84.5h-48.72v55.5h48.72v134.25C86.43,369.92,23.41,311.86,5.56,237.32c-2.34-9.78-3.21-19.77-5.3-29.57.59-10.25-.8-21.36,0-31.5C7.49,84.32,85.2,6.79,177.14,0h29.98Z'/%3e%3cpath%20class='st1'%20d='M.25,207.75c2.09,9.8,2.96,19.79,5.3,29.57,17.85,74.54,80.87,132.6,156.59,144.43v-134.25h-48.72v-55.5h48.72c1.31-28.23-4.86-58.8,9.61-84.5,11.42-20.28,32.32-30.81,55.19-32.53,16.97-.39,33.93.82,50.62,3.78v47.25h-28.86c-12.89,0-26.61,12.81-26.61,25.88v40.12h53.21l-8.24,55.5h-44.97v134.25c77.97-12.15,142.16-73.21,157.91-150.61,1.58-7.77,2.12-15.7,3.98-23.39v176.25H.25v-176.25Z'/%3e%3cpath%20class='st2'%20d='M177.14,0C85.2,6.79,7.49,84.32.25,176.25V0h176.88Z'/%3e%3cpath%20class='st2'%20d='M207.12,0h176.88v177c-1.68-6.89-2.04-14.03-3.36-21.02C366.99,83.72,311.48,24.45,240.42,6.05L207.12,0Z'/%3e%3c/svg%3e";
const googleIcon = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20version='1.1'%20viewBox='0%200%20384%20384'%3e%3c!--%20Generator:%20Adobe%20Illustrator%2029.7.1,%20SVG%20Export%20Plug-In%20.%20SVG%20Version:%202.1.1%20Build%208)%20--%3e%3cdefs%3e%3cstyle%3e%20.st0%20{%20fill:%20%23d83f22;%20}%20.st1%20{%20fill:%20%23fe4b26;%20}%20.st2%20{%20fill:%20%23fdfefd;%20}%20.st3%20{%20fill:%20%23177ee5;%20}%20.st4%20{%20fill:%20%23fefefd;%20}%20.st5%20{%20fill:%20%2310993e;%20}%20.st6%20{%20fill:%20%23fed401;%20}%20.st7%20{%20fill:%20%23fefefe;%20}%20.st8%20{%20fill:%20%2313b247;%20}%20.st9%20{%20fill:%20%23fdfefe;%20}%20%3c/style%3e%3c/defs%3e%3cpath%20class='st7'%20d='M206.98,0h176.79v180.7c-.24-2.96-1.42-9.44-2.29-12.33-1.97-6.57-5.62-9.35-12.41-10.07-53.29.41-106.88-1.3-160,.87-4.4,1.42-8.12,5.25-8.76,9.98,1.01,16.91-1.57,35.78-.1,52.45.39,4.45,2.3,8,6.24,10.25.82.47,4.83,2.09,5.4,2.09h88.77c-8.87,23.76-28.16,46.63-50.19,59.23-16.6,9.49-39.28,15.59-58.43,15.75-40.79.32-80.92-23.4-101.13-58.48-20.77-36.05-20.78-80.9,0-116.97s60.36-58.93,101.13-58.48c25.28.28,46.42,7.95,67.21,21.58,9.27,6.08,13.03,13.35,24.57,3.93,8.34-6.8,27.83-26.16,34.45-34.5,10.42-13.13-1.84-20.67-11.68-28.
%23fff;%20}%20%3c/style%3e%3c/defs%3e%3cpath%20d='M6.15,18.22c-1.02-.26-1.75-1.15-2.34-1.98-1.49-2.09-2.49-5.12-2.02-7.69s2.75-4.67,5.49-3.91c.85.24,1.51.79,2.42.52.62-.19,1.19-.5,1.85-.63,1.64-.34,3.56.25,4.47,1.71-.58.41-1.14.89-1.49,1.52-.68,1.25-.58,3,.2,4.18.43.64,1.1,1.1,1.78,1.46-.39,1.27-1.11,2.5-1.94,3.53s-1.56,1.52-2.9,1.17c-.59-.15-1.14-.48-1.77-.57-.9-.13-1.71.19-2.53.52l-.68.19h-.53Z'/%3e%3cpath%20class='st0'%20d='M6.15,18.22H0V0h18.22v18.22H6.68l.68-.19c.82-.32,1.62-.65,2.53-.52.63.09,1.18.42,1.77.57,1.34.35,2.1-.16,2.9-1.17s1.55-2.26,1.94-3.53c-.67-.35-1.35-.82-1.78-1.46-.78-1.18-.89-2.93-.2-4.18.35-.64.91-1.11,1.49-1.52-.91-1.45-2.83-2.04-4.47-1.71-.66.14-1.23.45-1.85.63-.91.27-1.56-.28-2.42-.52-2.74-.76-5.01,1.31-5.49,3.91s.53,5.6,2.02,7.69c.59.82,1.31,1.72,2.34,1.98ZM12.72.04c-2.08.2-3.81,2.07-3.66,4.19h.59c1.31,0,3.07-2.07,3.07-3.32V.04Z'/%3e%3cpath%20d='M12.72.04v.87c0,1.25-1.76,3.32-3.07,3.32h-.59c-.15-2.13,1.58-4,3.66-4.19Z'/%3e%3c/svg%3e";
const xIcon = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20version='1.1'%20viewBox='0%200%20921.6%20921.6'%3e%3c!--%20Generator:%20Adobe%20Illustrator%2029.7.1,%20SVG%20Export%20Plug-In%20.%20SVG%20Version:%202.1.1%20Build%208)%20--%3e%3cdefs%3e%3cstyle%3e%20.st0%20{%20fill:%20%23fff;%20}%20%3c/style%3e%3c/defs%3e%3cpolygon%20class='st0'%20points='10.78%20921.6%200%20921.6%200%200%20921.6%200%20921.6%20921.6%20909.02%20921.6%20546.36%20392.2%20880.28%201.8%20802.13%201.8%20511.1%20339.5%20277.56%201.8%2010.78%201.8%20360.5%20512.89%2010.78%20921.6'/%3e%3cpath%20d='M10.78,921.6l349.72-408.71L10.78,1.8h266.78l233.55,337.71L802.13,1.8h78.15l-333.92,390.4,362.66,529.4h-267.68l-243.45-355.73L89.82,921.6H10.78ZM240.73,61.08h-122.16l561.4,803.03h119.47l-7.51-13.15L240.73,61.08Z'/%3e%3cpolygon%20class='st0'%20points='89.82%20921.6%20397.9%20565.87%20641.35%20921.6%2089.82%20921.6'/%3e%3cpolygon%20class='st0'%20points='240.73%2061.08%20791.93%20850.97%20799.44%20864.11%20679.97%20864.11%20118.57%2061.08%20240.73%2061.08'/%3e%3c/svg%3e";
const LoginForm = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-14 rounded-xl shadow-2xl w-full max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-bold text-text-dark", children: "Login" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-text-medium mt-3 mb-6", children: "Please enter your login details to sign in" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLogin, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6 mt-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center text-text-medium", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "checkbox",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-sm", children: "Keep me logged in" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/forgot-password", className: "text-sm text-primary hover:brightness-90", children: "Forgot password?" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-text-medium", children: [
        "Don't have an account?",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", className: "font-bold text-primary hover:brightness-90", children: "Sign up" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center my-6 mt-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-grow border-t border-gray-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink mx-4 text-text-medium text-sm", children: "or continue with" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-grow border-t border-gray-400" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center space-x-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SocialButton, { provider: "Facebook", iconSrc: facebookIcon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SocialButton, { provider: "Google", iconSrc: googleIcon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SocialButton, { provider: "Apple", iconSrc: appleIcon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SocialButton, { provider: "X", iconSrc: xIcon })
      ] })
    ] })
  ] });
};
const LoginPage = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 bg-cover bg-center z-0",
        style: { backgroundImage: `url(${stock})` },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-white/30 backdrop-blur-sm" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center pt-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginForm, {}) })
    ] })
  ] });
};
const SignupForm = () => {
  const [email, setEmail] = reactExports.useState("");
  const [password, setPassword] = reactExports.useState("");
  const [repeatPassword, setRepeatPassword] = reactExports.useState("");
  const [showPassword, setShowPassword] = reactExports.useState(false);
  const [showRepeatPassword, setShowRepeatPassword] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-14 rounded-xl shadow-2xl w-full max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-bold text-text-dark", children: "Sign in" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-text-medium mt-3 mb-6", children: "Create your account in seconds" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSignup, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start mb-6 mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "agreeToTerms", className: "ml-2 text-sm text-text-medium", children: [
          "I agree to the",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/terms", className: "text-primary hover:brightness-90", children: "Terms of Service" }),
          " ",
          "and",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/privacy", className: "text-primary hover:brightness-90", children: "Privacy Policy" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-text-medium", children: [
        "Already a member?",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "font-bold text-primary hover:brightness-90", children: "Log in" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center my-6 mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-grow border-t border-gray-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink mx-4 text-text-medium text-sm", children: "or continue with" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-grow border-t border-gray-400" })
      ] }),
...
const SignupPage = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center pt-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SignupForm, {}) })
    ] })
  ] });
};
const editIcon = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20version='1.1'%20viewBox='0%200%20512%20512'%3e%3c!--%20Generator:%20Adobe%20Illustrator%2029.7.1,%20SVG%20Export%20Plug-In%20.%20SVG%20Version:%202.1.1%20Build%208)%20--%3e%3cdefs%3e%3cstyle%3e%20.st0%20{%20fill:%20%23fff;%20}%20%3c/style%3e%3c/defs%3e%3cpath%20class='st0'%20d='M0,142V0h511.71v47c-2.86-23.86-25.68-44.5-49.43-46.03-33.24-2.15-49.12,24.64-70.42,44.67l74.52,75.29c1.21.23,1.64-.82,2.39-1.39,9.15-7.03,33.62-
const JobApplicationCard = ({ application, onDelete, onEdit }) => {
  const [isNoteExpanded, setIsNoteExpanded] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card p-10 px-20 rounded-xl shadow-md hover:shadow-lg transition-shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-6 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-between h-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-text-dark mb-1", children: application.position }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-text-medium font-medium", children: application.company })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-text-medium", children: [
          "Applied: ",
          application.appliedDate
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center", children: application.notes ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-text-dark text-sm mb-2", children: "Notes:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-dark leading-relaxed", children: truncateText(application.notes) })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-20 w-full" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end justify-between h-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: trashIcon, alt: "Delete", className: "w-4 h-4" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "p-2 bg-white rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-200",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: editIcon, alt: "Edit", className: "w-4 h-4" })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `inline-block px-8 py-2 rounded-lg text-gray-800 font-medium text-sm min-w-32 text-center ${getStatusColor(application.status)}`, children: getStatusText(application.status) }) })
      ] })
    ] }) }),
    isNoteExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 backdrop-blur-md flex items-center justify-center z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-yellow-300 rounded-lg p-6 max-w-md w-80 shadow-2xl transform rotate-1 relative border-l-4 border-yellow-400", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-2 left-1/2 transform -translate-x-1/2 w-16 h-4 bg-yellow-400 rounded-sm opacity-80 shadow-sm" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-800 mb-4", children: "Notes:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-64 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 leading-relaxed text-base whitespace-pre-wrap", children: application.notes }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-yellow-400 rounded-lg -z-10 transform translate-x-1 translate-y-1 opacity-30" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-yellow-500 rounded-lg -z-20 transform translate-x-2 translate-y-2 opacity-20" })
    ] }) }) })
  ] });
};
const stickyNoteIcon = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20version='1.1'%20viewBox='0%200%20384%20384'%3e%3c!--%20Generator:%20Adobe%20Illustrator%2029.7.1,%20SVG%20Export%20Plug-In%20.%20SVG%20Version:%202.1.1%20Build%208)%20--%3e%3cdefs%3e%3cstyle%3e%20.st0%20{%20fill:%20%23f6954a;%20}%20.st1%20{%20fill:%20%23fec92b;%20}%20%3c/style%3e%3c/defs%3e%3cpath%20class='st1'%20d='M357.75,228h-97.12c-17.18,2.12-30.6,15.39-32.62,32.64v97.11c-4.08.86-8.17,2.01-12.36,2.28-51.46,3.31-106.44-2.53-158.27-.04-17.72-1.57-31.83-15.59-33.41-33.34V57.35c1.77-18.1,15.83-32.1,34.12-33.38h268.56c17.77,1.69,31.84,15.57,33.34,33.42-2.49,51.82,3.35,106.81.04,158.27-.27,4.19-1.42,8.28-2.28,12.34Z'/%3e%3cpath%20class='st0'%20d='M357.75,228c-2.93,13.88-8.08,25.36-17.27,36.35-34.71,28.16-67.4,83.86-112.48,93.4v-97.11c2.03-17.25,15.46-30.52,32.63-32.63h97.12Z'/%3e%3c/svg%3e";
const JobApplicationCardGrid = ({ application, onDelete, onEdit }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow h-64 flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-text-dark mb-1", children: application.position }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-text-medium font-medium mb-4", children: application.company }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-text-medium", children: [
          "Applied: ",
          application.appliedDate
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          application.notes && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => setIsNoteExpanded(true),
              className: "p-2 bg-white rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-200",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: stickyNoteIcon, alt: "Notes", className: "w-4 h-4" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `inline-block px-4 py-1 rounded-lg text-white font-medium text-xs text-center ${getStatusColor(application.status)}`, children: getStatusText(application.status) })
      ] })
    ] }),
    isNoteExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 backdrop-blur-md flex items-center justify-center z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-yellow-300 rounded-lg p-6 max-w-md w-80 shadow-2xl transform rotate-1 relative border-l-4 border-yellow-400", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-2 left-1/2 transform -translate-x-1/2 w-16 h-4 bg-yellow-400 rounded-sm opacity-80 shadow-sm" }),
...
const ApplicationList = ({
  ...
  if (applications.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-text-medium text-lg", children: "No applications found" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: viewMode === "column" ? "space-y-4" : "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6", children: applications.map((application) => viewMode === "column" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    JobApplicationCard,
    {
      application,
      onDelete,
...
const rowIcon = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20version='1.1'%20viewBox='0%200%20384%20384'%3e%3c!--%20Generator:%20Adobe%20Illustrator%2029.7.1,%20SVG%20Export%20Plug-In%20.%20SVG%20Version:%202.1.1%20Build%208)%20--%3e%3cdefs%3e%3cstyle%3e%20.st0%20{%20fill:%20%23fff;%20}%20%3c/style%3e%3c/defs%3e%3cpath%20class='st0'%20d='M384,0v384H0V0h384ZM44.84,48.96c-11.79,1.87-19.25,9.91-20.12,21.88-.59,8.16-.93,28.68,1.91,35.65,3.04,7.47,10.25,12.22,18.07,13.43l294.66.07c9.61-.88,19.28-8.56,20.57-18.43.93-7.12.85-26.43.07-33.69-1.12-10.32-10.7-18.13-20.72-19.03l-294.45.12ZM43.32,156.95c-7.32,1.53-13.84,6.31-16.69,13.31s-2.54,27.63-1.91,35.65c1.09,13.85,11.53,22.08,25.12,22.13h285.82c10.73.08,22.73-7.15,24.28-18.48.95-6.92.84-26.59.07-33.69-1.03-9.5-9.81-17.95-19.21-19.04l-297.47.11ZM42.57,264.95c-10.25,2-17.04,10.95-17.85,21.15-.63,8.02-.9,28.77,1.91,35.65,2.99,7.34,9.64,12.08,17.33,13.42l296.92.09c8.82-.96,17.97-9.54,19.04-18.46.8-6.73.87-32.08-1.06-37.77-2.55-7.49-9.01-12.36-16.54-14.21l-299.74.13Z'/%3e%3cpath%20d='M44.84,48.96l294.45-.12c10.02.89,19.6,8.71,20.72,19.03.79,7.26.86,26.57-.07,33.69-1.29,9.87-10.96,17.55-20.57,18.43l-294.66-.07c-7.82-1.21-15.03-5.95-18.07-13.43-2.84-6.97-2.5-27.5-1.91-35.65.87-11.97,8.33-20.01,20.12-21.88Z'/%3e%3cpath%20d='M43.32,156.95l297.47-.11c9.41,1.09,18.18,9.54,19.21,19.04.77,7.1.88,26.77-.07,33.69-1.55,11.33-13.55,18.56-24.28,18.47H49.84c-13.58-.05-24.02-8.28-25.12-22.13-.63-8.02-.9-28.77,1.91-35.65s9.37-11.78,16.69-13.31Z'/%3e%3cpath%20d='M42.57,264.95l299.74-.13c7.53,1.85,14,6.71,16.54,14.21,1.93,5.69,1.87,31.04,1.06,37.77-1.07,8.93-10.22,17.51-19.04,18.46l-296.92-.09c-7.68-1.35-14.34-6.09-17.33-13.42-2.8-6.88-2.54-27.63-1.91-35.65.8-10.2,7.6-19.16,17.85-21.15Z'/%3e%3c/svg%3e";
const gridIcon = "/assets/grid_menu-B-Kp3Ht8.svg";
const FilterDropdown = ({ selectedStatus, onStatusChange, viewMode, onViewToggle }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 mt-2 w-full bg-white rounded-lg shadow-lg border border-gray-200 z-50", children: statusOptions.map((option, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => handleStatusChange(option),
          className: `block w-full text-left px-4 py-2 text-sm text-text-dark hover:bg-gray-50 transition-colors ${index === 0 ? "rounded-t-lg" : ""} ${index === statusOptions.length - 1 ? "rounded-b-lg" : ""} ${selectedStatus === option ? "bg-gray-100 font-medium" : ""}`,
          children: [
            "Filter by Status: ",
            option
          ]
...
const searchIcon = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20version='1.1'%20viewBox='0%200%20491.52%20491.52'%3e%3c!--%20Generator:%20Adobe%20Illustrator%2029.7.1,%20SVG%20Export%20Plug-In%20.%20SVG%20Version:%202.1.1%20Build%208)%20--%3e%3cdefs%3e%3cstyle%3e%20.st0%20{%20fill:%20%23fff;%20}%20%3c/style%3e%3c/defs%3e%3cpath%20class='st0'%20d='M193.54,0l-2.31,1C62.65,9.82-28.16,135.59,9.56,261.11c38.82,129.17,192.84,184.76,307.5,113.92,7.04-4.35,13.42-9.79,20.54-13.67l128.11,125.79c10.39,7.12,21.98,2.49,25.81-9.04v13.41H0V0h193.54Z'/%3e%3cpath%20class='st0'%20d='M220.37,0h271.15v471.4l-131.19-131.87c20.62-23.72,37.08-51.09,45.65-81.58C438.37,142.6,365.09,28.96,250.1,4.28l-29.73-4.28Z'/%3e%3cpath%20d='M220.37,0l29.73,4.28c114.99,24.68,188.27,138.32,155.87,253.66-8.56,30.49-25.02,57.86-45.65,81.58l131.19,131.87v6.71c-3.82,11.53-15.42,16.16-25.81,9.04l-128.11-125.79c-7.13,3.87-13.5,9.32-20.54,13.67-114.66,70.84-268.68,15.25-307.5-113.92C-28.16,135.59,62.65,9.82,191.23,1l2.31-1h26.83ZM191.43,31.9C54,42.58-16.89,206.16,72.85,312.8c87.33,103.78,260.43,71.73,301.08-58.16,37.46-119.74-59.74-232.27-182.49-222.73Z'/%3e%3cpath%20class='st0'%20d='M191.43,31.9c122.75-9.54,219.95,102.99,182.49,222.73-40.64,129.9-213.75,161.94-301.08,58.16C-16.89,206.16,54,42.58,191.43,31.9Z'/%3e%3c/svg%3e";
const SearchBar = ({ searchTerm, onSearchChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-3 top-1/2 transform -translate-y-1/2 p-1 bg-white rounded", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: searchIcon,
        alt: "Search",
...
const AddApplicationForm = ({ isOpen, onClose, onSave, editData }) => {
  ...
  const [isStatusDropdownOpen, setIsStatusDropdownOpen] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 backdrop-blur-md flex items-center justify-center z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl shadow-2xl p-8 max-w-lg w-full mx-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary text-black shadow-md p-4 rounded-t-lg -mt-8 -mx-8 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-extrabold", children: editData ? "Edit Application" : "Add New Application" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-text-dark text-sm font-medium mb-2", children: "Company Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-text-dark text-sm font-medium mb-2", children: "Job Title" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-text-dark text-sm font-medium mb-2", children: "Date applied" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "date",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-text-dark text-sm font-medium mb-2", children: "Status" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: getStatusDisplayText(formData.status) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "svg",
                    {
            ...
            isStatusDropdownOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 mt-2 w-full bg-white rounded-lg shadow-lg border border-gray-200 z-50", children: statusOptions.map((option, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => handleStatusChange(option),
                className: `block w-full text-left px-4 py-2 text-sm text-text-dark hover:bg-gray-50 transition-colors ${index === 0 ? "rounded-t-lg" : ""} ${index === statusOptions.length - 1 ? "rounded-b-lg" : ""} ${formData.status === option ? "bg-gray-100 font-medium" : ""}`,
                children: getStatusDisplayText(option)
              },
              option
            )) })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-text-dark text-sm font-medium mb-2", children: "Notes" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            name: "notes",
...
const DashboardPage = () => {
  const [applications, setApplications] = reactExports.useState(mockApplications);
  const [filterStatus, setFilterStatus] = reactExports.useState("All");
  const [searchTerm, setSearchTerm] = reactExports.useState("");
  const [showAddForm, setShowAddForm] = reactExports.useState(false);
  const [editingApplication, setEditingApplication] = reactExports.useState(null);
  const [viewMode, setViewMode] = reactExports.useState("column");
  const filteredApplications = applications.filter((app) => {
    const matchesStatus = filterStatus === "All" || app.status === filterStatus.toLowerCase();
    const matchesSearch = app.position.toLowerCase().includes(searchTerm.toLowerCase()) || app.company.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { onAddApplication: () => setShowAddForm(true) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container mx-auto px-8 md:px-16 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-text-dark mb-8", children: "My applications" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row justify-end items-start sm:items-center gap-4 mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          FilterDropdown,
          {
...
clientExports.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Provider_default, { store, children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) }) })
);
